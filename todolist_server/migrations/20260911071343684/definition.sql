...
--
-- Class TodoActivity as table todo_activity
--
...
--
-- Class TodoChatMessage as table todo_chat_message
--
...
--
-- Class TodoList as table todo_list
--
...
--
-- Class TodoListMember as table todo_list_member
--
...
--
-- Class TodoNote as table todo_note
--
...
-- Indexes
CREATE INDEX "todo_note_list_idx" ON "todo_note" USING btree ("todoListId");

--
-- Class UserAccountProfile as table user_account_profile
--
...
-- Indexes
CREATE UNIQUE INDEX "user_account_profile_user_idx" ON "user_account_profile" USING btree ("userId");
...
--
-- Foreign relations for "todo_activity" table
--
...
--
-- Foreign relations for "todo_chat_message" table
--
...
--
-- Foreign relations for "todo_list_member" table
--
